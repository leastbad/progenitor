class User < ApplicationRecord
  ...
  devise :registerable, :rememberable, :validatable, :masqueradable, :two_factor_authenticatable, :otp_secret_encryption_key => Rails.application.credentials.devise_two_factor
  include Uploadable
