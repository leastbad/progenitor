...
module Mole
  ...
  class RowRenderer
    ...
    def initialize(row:, width:, height:, color_scheme:)
      ...
      @width = width
      @height = height
      @color_decorator = Mole::Decorators::ColorDecorator.new(color_scheme)
    end
    ...
    def render_span(column, span)
      ...
      until line_content.nil? || line_content.empty?
        if column.word_wrap == Mole::Column::WORD_WRAP_NORMAL
        ...
        elsif column.word_wrap == Mole::Column::WORD_WRAP_BREAK_WORD
